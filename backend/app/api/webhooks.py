...
from app.jobs.diagnose import run_diagnosis_async
...
async def cloudwatch_webhook(request: Request, background_tasks: BackgroundTasks):
    ...
    background_tasks.add_task(run_diagnosis_async, incident.id)
